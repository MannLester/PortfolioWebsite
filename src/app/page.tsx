        ...
        <div className="w-[50%] relative">
          ...
          <div className="absolute right-[10%] top-[20%] text-right pr-8 flex flex-col items-end">
            ...
            <div className="relative w-[350px]">
              ...
              <motion.div 
                className={`absolute top-16 right-0 z-10 text-[98px] text-white leading-none whitespace-nowrap ${anton.className}`}
              ...
              >
                ...
                <motion.div 
                  className={`absolute -bottom-4 right-0 z-30 text-[72px] text-white leading-none whitespace-nowrap ${anton.className}`}
                  initial={{ opacity: 0, x: 20 }}
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.5, delay: 0.8 }}
                >
