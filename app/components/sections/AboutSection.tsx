        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-5 gap-12 items-start">
            ...
            <div className="md:col-span-2 flex justify-center">
              <div 
                className="w-64 h-64 md:w-80 md:h-80 bg-muted rounded-2xl border border-border flex items-center justify-center transition-all duration-1000 ease-in-out"
                style={{
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    <div 
                      key={tech.name} 
                      className="flex items-center gap-2 px-3 py-2 rounded-lg border border-border bg-card/50 hover:bg-card transition-colors group"
                    >
                      <Image 
                        src={tech.icon} 
                        alt={tech.name} 
                  ...
                  <div className="flex items-center px-3 py-2 rounded-lg border border-border bg-card/30 opacity-60">
